...
<div id="slider">
	...
	<div class="sidebarEntry"> 
		...
		<div class="sidebarHeader">
            <a href="<?php bloginfo('home'); ?>/big-pipe-line-donation"> <?php echo $highPriorityBigNeedItem; ?></a>
        </div>
		<div class="sidebarGuts">
		...
		<?php $donormeter = get_post_meta($post->ID,'donormeter',true);
          ...
          <a href="<?php bloginfo('home'); ?>/big-pipe-line-donation">Click here to donate</a>
          </div>
