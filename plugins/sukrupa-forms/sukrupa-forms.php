...
function ddfm_main_options() {
	...
	<?php 
		...
		$count = trim(get_option('ddfm_instancesddfm_instances'));
		for ($i = 1; $i <= $count; $i++) {
...
function activate_sukrupa_forms() {
    ...
    $sponsorship_page = array(
        ...
        'post_type' => 'page',
        'post_category' => array(0),
        'post_excerpt' => '<a href="http://beta.sukrupa.org/cost-breakdown/" target="_blank"><img src="http:/beta.sukrupa.org/wp-content/uploads/2011/04/sponsor.jpg"> </a>   ',
        'post_name' => 'sponsor'
    );
